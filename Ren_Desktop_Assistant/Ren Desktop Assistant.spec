...
a = Analysis(
    ...
    hiddenimports=['preferences', 'system_status', 'system_info', 'system_observer', 'downloads_organizer', 'debloat', 'modes', 'actions', 'history', 'action_registry', 'process_manager', 'startup_manager', 'services_manager', 'storage_cleaner', 'storage_analyzer', 'app_manager', 'tweaks_manager', 'privacy_center', 'network_center', 'health_diagnostics', 'restore_center', 'benchmark', 'app_gui', 'logger', 'single_instance', 'tray_manager', 'pystray', 'pystray._win32', 'PIL', 'PIL.Image', 'PIL.ImageDraw', 'psutil', 'powerplan', 'tkinter', 'tkinter.ttk', 'tkinter.filedialog', 'tkinter.messagebox'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
